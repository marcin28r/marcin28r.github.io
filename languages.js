const language_content = {
    "en": {
      ...
      "rules-1": "The physical version includes elements such as: discs, poles and a base. Although the classic layout refers to the legend included in the original set, the game itself can also be reproduced using only elements of different diameters placed on three stacks. Preparing the game involves constructing a tower of disks on the first stack so that the diameter of the disks decreases as the tower increases. The game is based on three main rules:",
      "mrule-1": "always lift one disk placed on the top of one of the three poles",
